%% Calculuating Error
% Chenhao Li, Jin Cheng, Yidan Gao presented
...
fprintf('The difference of P between your calculation and the example given is %e. \n',diff_P);
fprintf('The difference of G between your calculation and the example given is %e. \n',diff_G);
